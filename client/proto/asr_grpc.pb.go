...
const (
	ASRService_TranscribeStream_FullMethodName = "/asr.ASRService/TranscribeStream"
)
...
type ASRServiceClient interface {
	...
	TranscribeStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AudioChunk, TranscriptChunk], error)
}
...
func (c *aSRServiceClient) TranscribeStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AudioChunk, TranscriptChunk], error) {
...
type ASRService_TranscribeStreamClient = grpc.BidiStreamingClient[AudioChunk, TranscriptChunk]
...
type ASRServiceServer interface {
	// Bidirectional streaming: client sends audio chunks, server responds with partial transcriptions.
	TranscribeStream(grpc.BidiStreamingServer[AudioChunk, TranscriptChunk]) error
...
func (UnimplementedASRServiceServer) TranscribeStream(grpc.BidiStreamingServer[AudioChunk, TranscriptChunk]) error {
...
func _ASRService_TranscribeStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ASRServiceServer).TranscribeStream(&grpc.GenericServerStream[AudioChunk, TranscriptChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ASRService_TranscribeStreamServer = grpc.BidiStreamingServer[AudioChunk, TranscriptChunk]
